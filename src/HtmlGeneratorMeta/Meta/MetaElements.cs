namespace HtmlGenerator.Meta
{
    public static class MetaElements
    {
        ...
        public static ElementInfo Button => Custom("button", "AutoFocus", "Disabled", "Form", "FormAction", "FormEncType", "FormMethod", "FormNoValidate", "FormTarget", "Name", "Type", "Value");
        ...
        public static ElementInfo Col => Custom("col", true, "Span");
        public static ElementInfo Colgroup => Custom("colgroup", "Span");
        ...
        public static ElementInfo Del => Custom("del", "Cite", "DateTime");
        ...
        public static ElementInfo Ins => Custom("ins", "Cite", "DateTime");

        public static ElementInfo Kbd => Custom("kbd");

        public static ElementInfo Label => Custom("label", "For", "Form");
        ...
        public static ElementInfo Optgroup => Custom("optgroup", "Disabled", "Label");
        public static ElementInfo Option => Custom("option", "Disabled", "Label", "Selected", "Value");
        public static ElementInfo Output => Custom("output", "For", "Form", "Name");
        ...
        public static ElementInfo Q => Custom("q", "Cite");
        ...
        public static ElementInfo Select => Custom("select", "AutoFocus", "Disabled", "Form", "Multiple", "Name", "Required", "Size");
        ...
        public static ElementInfo Track => Custom("track", true, "Default", "Kind", "Label", "Src", "SrcLang");
        ...
        private static ElementInfo Custom(string tag, params string[] attributes) => Custom(tag, false, attributes);
        private static ElementInfo Custom(string tag, bool isVoid, params string[] attributes) => new ElementInfo(tag, isVoid, attributes);
    }
}
