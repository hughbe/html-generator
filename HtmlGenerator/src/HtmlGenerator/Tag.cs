namespace HtmlGenerator
{
    public struct Tag
    {
        ...
        public static HtmlElement Link => Custom("link", true); //Uses attributes (crossorigin, href, hreflang, integrity, media, rel, sizes, type)
        public static HtmlElement Style => Custom("style"); //Uses attributes (type, media, scoped, title, disabled)

        public static HtmlElement Meta => Custom("meta", true); //Uses attributes (charset, content, http-equiv, default-style, refresh, name)
        public static HtmlElement Title => Custom("title");

        public static HtmlElement Script => Custom("script"); //Uses attributes (async, integrity, src, type, text, defer, crossorigin)
        ...
        //Text
        public static HtmlElement A => Custom("a"); //Uses attributes (download, href, hreflang, media, ping, rel, target, type)
        ...
        //Multimedia
        public static HtmlElement Area => Custom("area", true); //Uses attributes (alt, coords, download, href, hreflang, media, rel, shape, target, type)
        public static HtmlElement Audio => Custom("audio"); //Uses attributes (autoplay, buffered, controls, loop, muted, played, preload, src, volume)
        public static HtmlElement Img => Custom("img", true); //Uses attributes (alt, crossorigin, height, ismap, longdesc, sizes, src, srcset, width, usemap)
        ...
        public static HtmlElement Video => Custom("video"); //Uses attributes (autoplay, buffers, controls, crossorigin, height, loop, muted, played, preload, poster, src, width)

        //Embedding
        public static HtmlElement Embed => Custom("embed", true); //Uses attributes (height, src, type, width)
        public static HtmlElement Iframe => Custom("iframe"); //Uses attributes (allowfullscreen, height, name, sandbox, seamless, src, srcdoc, width)
        public static HtmlElement Object => Custom("object"); //Uses attributes (data, form, height, height, name, type, typemustmatch, usemap, width)
        ...
        //Forms
        public static HtmlElement Button => Custom("button"); //Uses attributes (autofocus, disabled, form, formaction, formenctype, formmethod, formnovalidate, formtarget, name, type, value)
        ...
        public static HtmlElement Meter => Custom("meter"); //Uses attributes (value, min, max, low, high, optimum, form)
        ...
        public static HtmlElement Select => Custom("select"); //Uses attributes (autofocus, disabled, form, multiple, name, required, size)
        public static HtmlElement TextArea => Custom("textarea"); //Uses attributes (autocomplete, autofocus, cols, disabled, form, maxlength, minLength, name, placeholder, readonly, required, rows, selectionDirection, selectionEnd, selectionStart, spellcheck, wrap)
        ...
        public static HtmlElement MenuItem => Custom("menutiem", true); //Uses attributes (checked, command, default, disabled, icon, label, radiogroup, type); Unsupported
