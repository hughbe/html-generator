namespace HtmlGenerator
{
    public class HtmlFooterElement : HtmlElement 
    {
		...
		public HtmlFooterElement WithContextMenuAttribute(string value) => (HtmlFooterElement)WithAttribute(Attribute.ContextMenu(value));
		...
		public HtmlFooterElement WithStyleAttribute(string value) => (HtmlFooterElement)WithAttribute(Attribute.Style(value));
