namespace HtmlGenerator
{
    public class HtmlDetailsElement : HtmlElement 
    {
		...
		public HtmlDetailsElement WithContextMenuAttribute(string value) => (HtmlDetailsElement)WithAttribute(Attribute.ContextMenu(value));
		...
		public HtmlDetailsElement WithStyleAttribute(string value) => (HtmlDetailsElement)WithAttribute(Attribute.Style(value));
